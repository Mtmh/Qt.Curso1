        ...
        const QStyleOptionViewItem &, const QModelIndex &) const
{
    ...
    doubleSpinBox->setMinimum(-999999999.999999999);
    doubleSpinBox->setMaximum(+999999999.999999999);
...
void NumeroRealSpinBoxDelegate::setModelData(QWidget *editor,QAbstractItemModel *model,
         const QModelIndex &index) const
{
    auto doubleSpinBox = static_cast<QDoubleSpinBox *>(editor);
